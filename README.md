...
Doc-first AI dev workflow. One mode reads one file and touches one kind of artifact.
...
_Generated from `versions/0.60.0/`, version 0.60.0. Do not hand-edit; regenerate with `scripts/build.sh`._
